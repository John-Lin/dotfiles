...
- Before starting complex tasks, use Context7 find-docs skill when I need library/API documentation, code generation, setup or configuration steps without me having to explicitly ask.
